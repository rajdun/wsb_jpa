...
values (1001, 'ul. Kliniczna 5', 'blok C', 'Warszawa', '00-001'),
...
values (101, 1001, 'DOC/101', 'jan.kowalski@med.pl', 'Jan', 'Kowalski', '+48 123 456 789', 'GP'),
...
-- 3. Patients
insert into patient (id, date_of_birth, address_id, email, first_name, last_name, patient_number, telephone_number,
                     height)
values (201, '1985-03-15', 1001, 'krzysztof.zielinski@mail.com', 'Krzysztof', 'Zieliński', 'P2024/001',
        '+48 600 123 456', 188),
       (202, '1999-07-22', 1002, 'agnieszka.kaminska@op.pl', 'Agnieszka', 'Kamińska', 'P2024/002', '+48 505 987 654',
        192),
       (203, '1978-11-30', 1003, 'piotr.lewandowski@gmail.com', 'Piotr', 'Lewandowski', 'P2024/003', '+48 888 222 333',
        201),
       (204, '2005-05-05', 1004, 'zuzanna.dabrowska@wp.pl', 'Zuzanna', 'Dąbrowska', 'P2024/004', '+48 600 555 000',
        195);

-- 4. Visits
insert into visit(id, doctor_id, patient_id, time, description)
values (301, 101, 201, '2024-03-25 10:00:00', 'Rutynowa kontrola ogólna'),
...
values (301, 'Podstawowe badanie EKG', 'EKG'),
